<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
		...
		<ul class="nav navbar-nav navbar-left in">
         ...
         <!-- Start Apps Dropdown -->
        <ul class="nav navbar-nav navbar-left in d-md-none">
                    ...
                    <ul class="dropdown-menu app-icon">
                        ...
                        <li>
                            <ul class="dropdown-menu-list app-icon-dropdown" data-handle-color="#637283">
								<li>
									<a href="/nhom-loai" class="patient-icon">
									<i class="material-icons">local_hotel</i>
									<span class="block">Nhóm & Loại</span>
									</a>
								</li>
								<li>
									<a href="/su-co" class="email-icon">
									<i class="material-icons">drafts</i>
									<span class="block">Sự Cố</span>
									</a>
								</li>
								<li>
								...
								<li>
									...
									<span class="block">Thông Báo</span>
									</a>
								</li>
								<li>
									<a href="google_maps.html" class="map-icon">
									<i class="material-icons">map</i>
									<span class="block">Nhân Viên</span>
									</a>
								</li>
								<li>
									<a href="payments.html" class="payment-icon">
									<i class="material-icons">monetization_on</i>
									<span class="block">Cashier</span>
									</a>
								</li>
                            </ul>
                        </li>
        ...
        <ul class="d-xs-none navbar-left navbar-main">
            ...
            <li>
                <i class="fa fa-bug"></i>&nbsp;
                <a class="parent-item" href="/su-co">SỰ CỐ</a>&nbsp;
            </li>
            <li>
                <i class="fa fa-shopping-cart"></i>&nbsp;
                <a class="parent-item" href="/don-hang">ĐƠN HÀNG</a>&nbsp;
            </li>
            <li>
                <i class="fa fa-bell"></i>&nbsp;
                <a class="parent-item" href="/thong-bao">THÔNG BÁO</a>&nbsp;
            </li>
            <li>
                <i class="fa fa-users"></i>&nbsp;
                <a class="parent-item" href="/nhan-vien">NHÂN VIÊN</a>&nbsp;
            </li>
            <li>
                <i class="fa fa-dollar"></i>&nbsp;
                <a class="parent-item" href="/cashier">CASHIER</a>&nbsp;
            </li>
        </ul>
